  ...
  return (
    <div className={styles.create_post}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label>
            <span>Conteúdo:</span>
            <textarea name="body" required placeholder='Inisira o conteúdo do post' onChange={(e) => setBody(e.target.value)} value={body}></textarea>
          </label>
          <label>
            <span>Tags:</span>
            <input type="text" name="tags" required placeholder='Insira as tags separadas por viírgula'  onChange={(e) => setTags(e.target.value)} value={tags}/>
          </label>      
